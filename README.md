...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ivpsyyk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ivpsyyk.containers.anotherwebservice.com/
...
```
git clone git@github.com:kosei9987aaa/container-ivpsyyk.git
cd container-ivpsyyk
```
...
```
docker attach container-ivpsyyk
```
